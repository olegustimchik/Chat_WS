...
export class Migration1720511742209 implements MigrationInterface {
    name = 'Migration1720511742209'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(320) NOT NULL, "password" character varying(256), "name" character varying(256), "referralCode" character varying(60), "questionLeft" integer NOT NULL DEFAULT '5', "subscribed" boolean NOT NULL DEFAULT false, "nextPayment" TIMESTAMP, "passwordSalt" character varying(256), "externalType" character varying(16), "externalID" character varying(256), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_bf0e513b5cd8b4e937fa0702311" UNIQUE ("referralCode"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
